        ...
        <div className="flex flex-col md:flex-row justify-between items-center my-4 gap-8">
          <div className="flex-1 flex flex-col gap-2">
            <div className="max-w-lg">
              ...
              <p className="">
                A senior software engineer based in Wayne, NJ. Over the course
                of my 15-year career, I have immersed myself in the art of
                crafting software solutions that seamlessly align with
